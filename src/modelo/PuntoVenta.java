//package modelo;
import java.util.Scanner;//se importa las clases de pakage
...
public class PuntoVenta {
	...
	//constantes
	public final static int OPCION_MENU_SALIR = 8;//Constante
...
//do-while ES CREAR UN BUCLE(SIGNIFICA MIENTRA) HACER MIENTRAS LA CONDICION SE CUMPLA(SALIR)
		...
		System.out.printf("Seleccion� la Opci�n %d ", opcionSeleccionada);
/*System.out.printf() --String format
* %s = String, %d = N�mero entero, %f= n�mero con decimales, %n = Salto de linea
...
//volvemos a utilizar la clase scanner lo vamos a guardar en un array 
	...
	private static void verProducto() {//metodo
		...
		for(Producto producto : productos ) {
			System.out.printf("C�digo: %s Producto: %s Precio: %d  %n "
					, producto.getCodigo()
					, producto.getNombre()
					, producto.getPrecio());
		}
	...
	private static void cargarProductosiniciales() {
		...
		productos.add(new Producto("[ch2]","Chicle Fruta", 200));
		productos.add(new Producto("[ch3]","Cafe Nescafe 280 g", 2200));
	}
    ...
    try {
      ...
      //por implementar archivo de log
	    ...
	    private static String generarContenidoArchivosCSV(){
	        ...
	        contenidoArchivo += "ch2, Chicle Fruta, 200 \n";
	        contenidoArchivo += "ch3, Cafe Nescafe 280 g, 2200 \n";
	        // abreviación de esto:
	       //contenidoArchivo = contenidoArchivo + "\n";
	       contenidoArchivo += "ch4, Azucar, 1300\n";
